    ...
    <div className="min-h-screen bg-[#F8FAFC] py-12 px-4 sm:px-6 lg:px-8 font-sans" dir="rtl">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          {products.map((product) => (
            <Link
              ...
              className="group bg-white rounded-[2rem] shadow-sm hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden border border-gray-100 block"
            >
              ...
              <div className="p-8">
                ...
                <div className="flex items-center justify-between pt-6 border-t border-gray-50">
                  ...
                  <span className="bg-blue-50 text-blue-600 px-6 py-3 rounded-2xl font-bold text-sm group-hover:bg-blue-600 group-hover:text-white transition-all shadow-sm">
                    عرض التفاصيل
                  </span>
                </div>
              </div>
        ...
        <div className="text-center mt-16">
          <Link
            to="/Featured.html"
            className="inline-flex items-center bg-blue-600 text-white px-10 py-4 rounded-2xl font-bold text-lg hover:bg-blue-700 transition-all shadow-xl shadow-blue-200"
          >
            <ShoppingBag className="ml-2" size={24} />
            تسوق منتجات سموزي
          </Link>
        </div>
      </div>
