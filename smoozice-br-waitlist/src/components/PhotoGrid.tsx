...
import pinkBrushImg from "../assets/images/pink_brush_real.jpg";
import blackBrushImg from "../assets/images/black_brush_real.jpg";
import purpleBrushImg from "../assets/images/purple_brush_real.jpg";
import collageImg from "../assets/images/collage_brushes_1.jpg";
import collageImg2 from "../assets/images/collage_brushes_2.jpg";
...
export default function PhotoGrid({ highlightColor }: PhotoGridProps) {
  ...
  const collageImages = [
    ...
    { id: 7, src: collageImg2, className: "col-span-2 row-span-2 md:col-span-2 md:row-span-2", rotate: "rotate-0", color: null },
