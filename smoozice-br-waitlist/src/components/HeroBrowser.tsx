  ...
  return (
    <div id="hero-browser-wrapper" className="w-full max-w-2xl mx-auto px-4 py-6">
      <motion.div
        ...
        className="w-full rounded-2xl border-2 border-white bg-white/10 backdrop-blur-md shadow-xl overflow-hidden relative"
      >
        {/* Browser Top Header Bar */}
        <div className="flex items-center justify-between px-4 py-3 border-b border-white/20 bg-transparent select-none">
        ...
        <div className="relative h-[200px] flex items-center justify-center overflow-hidden">
          <motion.h1
            ...
            className="font-display font-black text-white text-7xl sm:text-8xl tracking-tighter select-none z-10 text-center lowercase"
          >
            waitlist
          </motion.h1>
        </div>
